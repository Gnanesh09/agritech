        ...
        <div className="relative z-10 max-w-2xl pt-4 text-center lg:text-left">
          ...
          <FadeUp className="mt-7" delay={0.08}>
            <h1 className="text-balance text-[2.7rem] font-semibold leading-[0.98] tracking-[-0.055em] text-[#12382a] sm:text-6xl lg:text-[clamp(3.7rem,5.4vw,5.5rem)]">
              Grow with clarity.
              <span className="block text-[#5d8e3e]">Farm with confidence.</span>
            </h1>
          </FadeUp>
          ...
          <FadeUp className="mt-6" delay={0.16}>
            <p className="mx-auto max-w-xl text-pretty text-base leading-7 text-[#496156] sm:text-lg sm:leading-8 lg:mx-0">
              Smart Agri brings crop monitoring, irrigation control, environmental analysis,
              and practical AI recommendations into one intelligent farming workspace.
            </p>
          </FadeUp>

          <FadeUp className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start" delay={0.24}>
            <a
              href="#contact"
          ...
          <FadeUp className="mt-10 grid grid-cols-3 border-t border-[#174b36]/15 pt-6 sm:mt-12" delay={0.32}>
            {highlights.map((highlight) => (
              <div className="border-r border-[#174b36]/15 px-2 first:pl-0 last:border-r-0 last:pr-0" key={highlight.label}>
                <p className="text-xl font-semibold tracking-[-0.04em] text-[#174b36] sm:text-2xl">{highlight.value}</p>
                <p className="mt-1 text-xs font-medium text-[#617369] sm:text-sm">{highlight.label}</p>
              </div>
            ))}
          </FadeUp>
        </div>

        <ScaleIn className="relative mx-auto w-full max-w-3xl lg:max-w-none" delay={0.12}>
          <div className="relative overflow-hidden rounded-[2rem] bg-[#174b36] p-2 shadow-[0_28px_80px_rgba(20,61,43,0.22)] sm:rounded-[2.5rem] sm:p-3">
            <Image
              src="/hero.png"
              ...
              className="aspect-[1.08/1] w-full rounded-[1.55rem] object-cover sm:aspect-[1.2/1] sm:rounded-[2rem]"
            />
            <div aria-hidden="true" className="absolute inset-3 rounded-[1.55rem] bg-gradient-to-t from-[#12382a]/45 via-transparent to-transparent sm:rounded-[2rem]" />

            <Floating className="absolute bottom-7 left-7 sm:bottom-10 sm:left-10" y={5} duration={6}>
              <div className="rounded-2xl border border-white/30 bg-white/90 px-3.5 py-3 shadow-xl backdrop-blur-md sm:px-4">
                ...
                <p className="mt-1 text-lg font-semibold tracking-[-0.03em] text-[#173c2c]">24&deg;C <span className="text-sm font-medium text-[#5a7266]">Clear</span></p>
              </div>
            </Floating>

            <Floating className="absolute right-7 top-7 hidden sm:block sm:right-10 sm:top-10" y={-5} duration={6.5} delay={0.4}>
              <div className="rounded-2xl border border-white/30 bg-[#174b36]/90 px-4 py-3 text-white shadow-xl backdrop-blur-md">
                ...
                <p className="mt-1 text-lg font-semibold tracking-[-0.03em]">63% <span className="text-sm font-medium text-green-100">Optimal</span></p>
              </div>
            </Floating>
          </div>
        </ScaleIn>
