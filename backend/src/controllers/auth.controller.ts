...
export async function register(req: Request, res: Response) {
  try {
    ...
    const { username, email, password, countryCode, phoneNo, role } = req.body;
    ...
    //
    // IMPORTANT:
    // Never trust ADMIN/SUPER_ADMIN from a public
    // registration request.
    //
    // Normal registration always creates USER.
    //
    // Admin promotion should be done separately.
    // ---------------------------------------------------------
    ...
    /*
     * If this endpoint is publicly accessible, I strongly
     * recommend forcing USER instead:
     *
